            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0 text-center text-warning">
                    <li class="nav-item me-xl-3 me-lg-1">
                        <a class="nav-link fs-5 text-light" aria-current="page" href="admin_bouquets.php">Home</a>
                    </li>
                    <li class="nav-item me-xl-3 me-lg-1">
                        <a class="nav-link fs-5 text-light" href="admin_orders.php#cusorder">Manage Orders</a>
                    </li>
                    <li class="nav-item me-xl-3 me-lg-1">
                        <a class="nav-link fs-5 text-light" href="add.php#add">Mangage Bouquets</a>
                    </li>
                ...
                <form class="d-flex" role="search" action="item1.php" method="GET">
